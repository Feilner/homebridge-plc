...
<!-- prettier-ignore -->
> [!NOTE]
>  - Compatible with the version of **Homebridge 2.0.0**
>  - Compatible with Node.js v24 and the latest Docker images of Homebridge
>  - It might be necessary to reinstall the plugin to update the node-snap7 dependancy
